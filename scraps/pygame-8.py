...
def decide_next(x, y, array, next_array, alive_color, dead_color):
    ...
    try:
        ...
        # a, b, c = array[y%Ny-1][x%Nx-1], array[y%Ny-1][x%Nx], array[y%Ny-1][x%Nx+1]
        # d, e = array[y%Ny][x%Nx-1], array[y%Ny][x%Nx+1]
        # f, g, h = array[(y%Ny+1)%Ny][x%Nx-1], array[y%Ny+1][x%Nx], array[y%Ny+1][x%Nx+1]
